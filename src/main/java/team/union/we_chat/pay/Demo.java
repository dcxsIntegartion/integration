package team.union.we_chat.pay;

import java.util.SortedMap;
import java.util.TreeMap;

import team.union.we_chat.utils.GetWxOrderno;
import team.union.we_chat.utils.RequestHandler;
import team.union.we_chat.utils.Sha1Util;
import team.union.we_chat.utils.TenpayUtil;
...
public class Demo {
	...
	private static String appid = "wx50e204de25ecc077";
	private static String appsecret = "39b6e13f720656e1b90ec191b5ee580f";
	private static String partner = "1448262102";
	//这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "6xq6v2hqj9433ct97m07ykqkkhxolwtd";
